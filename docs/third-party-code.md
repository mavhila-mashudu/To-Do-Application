...
| --- | --- | --- | --- |
| `better-sqlite3` | `^13.0.2` | Provides the Node.js interface used to access the local SQLite database. | It offers a direct, lightweight SQLite API suited to a local-first, single-user application. |
...
`ChatGPT work 5.6 Sol High` was used to inspect `package.json` and assist with drafting this dependency documentation. Package names and declared versions were checked against the current direct dependencies and development dependencies.
